...
heroImage: /images/engineering-first-ai-second.jpg
heroAlt: "Engineer first, AI second: an illustration of an engineering educator in front of a system architecture diagram with an AI assistant and students at work, captioned as a framework for AI-augmented engineering thinking"
---

I gave a flash talk at the Mines Generative AI Summit in Fall 2025 titled "Co-Creating with AI: New Frontiers in Teaching and Design." The argument I made there is the argument I want to make here, in longer form. As of Spring 2026 I am also a member of KERN Community Catalysts Cohort 13 and part of a select national group in the KEEN Crescendo Program. I think a lot about how AI changes engineering education. Most of the conversations I am in are still not very useful.
